...
namespace GeekShopping.PaymentAPI.RabbitMQSender
{
    public class RabbitMQMessageSender : IRabbitMQMessageSender
    {
        ...
        private const string PaymentEmailUpdateQueueName = "PàymentEmailUpdateQueueName";
        private const string PaymentOrderUpdateQueueName = "PàymentOrderUpdateQueueName";
